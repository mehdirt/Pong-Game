...
def draw(win: pygame.Surface, paddles: Paddle, ball, left_score: int, right_score: int) -> None:
    ...
    win.blit(left_score_text, (WIDTH * (3 / 4) - right_score_text.get_width() // 2, 20))
...
def handle_collision(ball: Ball, left_paddle: Paddle, right_paddle: Paddle) -> None: # TODO: Lots of repeatation, needs to add more functionality
